...
/**
 * A {@link Codec} for {@link OffsetDateTime} values.
 *
...
public class OffsetDateTimeCodec
    ...
    @Override
    public Class<OffsetDateTime> codecClass() {
    ...
    @Override
    public OffsetDateTime decode(final JsonTransport transport,
                                 final Parameter parameter,
                                 final JsonValue value,
                                 final Marshaller marshaller) {

        return value instanceof JsonNull ? null : OffsetDateTime.parse(value.asString().value());
    }
}
