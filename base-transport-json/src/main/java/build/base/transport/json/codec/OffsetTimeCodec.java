...
/**
 * A {@link Codec} for {@link OffsetTime} values.
 *
...
public class OffsetTimeCodec
    ...
    @Override
    public Class<OffsetTime> codecClass() {
    ...
    @Override
    public OffsetTime decode(final JsonTransport transport,
                             final Parameter parameter,
                             final JsonValue value,
                             final Marshaller marshaller) {

        return value instanceof JsonNull ? null : OffsetTime.parse(value.asString().value());
    }
}
