...
/**
 * A {@link Codec} for {@link ZoneId} values.
 *
...
public class ZoneIdCodec
    ...
    @Override
    public Class<ZoneId> codecClass() {
        return ZoneId.class;
    }
    ...
    @Override
    public ZoneId decode(final JsonTransport transport,
                         final Parameter parameter,
                         final JsonValue value,
                         final Marshaller marshaller) {

        return value instanceof JsonNull ? null : ZoneId.of(value.asString().value());
    }
}
